...
PROXY MISALIGNMENT BITES (asymmetric only), n=30 R=150: a compensatory sum-proxy is BENIGN under
symmetric costs (true min 74.9 vs aligned 73.7, marginally better) but BITES under asymmetric costs
(aligned true min 53.5 vs proxy 50.6, disjoint; proxy lopsidedness 34.5 vs 1.5) -- it pumps the cheap
dimension and abandons the expensive bottleneck. The graded aligned benchmark reveals the decoupling.
Signed as insight 055. Run-1 (direction-blind verdict) kept as exploratory.
